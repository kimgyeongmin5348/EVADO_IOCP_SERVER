...
// 
// 
//	2. NPC(몬스터) ai 만들기 [ 2025.07.22 ]
//		- 평소엔 가만히 있게 하는게 아니라 움직이게 해보자. (지금은 가만히 있는다. 플레이어가 주변에 와야 움직임)
//		- A* 구현중에 있음 (95%) [랜더링 되면 정확한 확인이 필요함]
// 
// 
// 
//	3. 아이템 스폰 설정 [ 2025.07.22 ]
//		- 아이템의 값어치 설정함.
// 
// 
// 
//	4. 플레이어 정보 저장 [ 2025.07.20 ]
...
//	5. 상점 [ 2025.07.22 ]
//		- 상점 관련 패킷과 함수들 생성함.
//		- 인벤토리나 상점 UI 생성되면 메커니즘을 수정해보거나 생각을 한번 더 해봐야 할것 같음.
// 
//----------------------------------------------------
